...
const Home = () => {
  return (
    <div id='main'>
      <img src="https://images.pexels.com/photos/2387793/pexels-photo-2387793.jpeg" alt="" className='w-full h-screen object-cover object-left scale-x-[-1]' />
        ...
        <div className='max-w-[700px]'>
          ...
          <h2 className='text-2xl'>
            <TypeAnimation
              ...
              speed={50}
              repeat={Infinity}
              style={{ fontSize: '1em', paddingLeft: '5px', color: 'white', opacity: 100 }}
            />
          </h2>
